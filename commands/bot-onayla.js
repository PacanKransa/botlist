...
module.exports = {
    ...
    const Embed = new Discord.MessageEmbed()
.setColor('BLUE')
.setTitle('🎉 Sana iyi haberim var!')
.setDescription(`🎉 Tebrikler! Light BotList #3.2K Adlı Sunucuda Sırada Olan \`${discordBot.tag}\`(**${discordBot.id}**) Adlı Botunuz Onaylandı! (Sunucudan Çıkarsan Atılacaktır.)`)
